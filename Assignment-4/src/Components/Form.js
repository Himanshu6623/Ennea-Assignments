    ...
    return(
        <>
            <div className="container">
                ...
                <div className="mb-3">
                  <textarea className="form-control" style={{backgroundColor: props.mode==='dark'?'black':'white', color: props.mode==='dark'?'white':'black'}} value={text} placeholder="Enter your text here" onChange={ChangeText} id="mybox" rows="6"></textarea>
                </div>
