...
export default function CoursesLogged() {
    ...
    const RemoveCourse = async () => {
     ...
     const { mutate: mutateRemove,Loading} = useMutation(RemoveCourse, {
       onSuccess: (data) => {
    ...
    const card = filteredProducts.map((product) => (
        <>
            ...
            >
                ...
                <StyledButton style={{backgroundColor:"green"}} onClick={deleteCourse}>{Loading?"Deleting...":"Delete"}</StyledButton>
